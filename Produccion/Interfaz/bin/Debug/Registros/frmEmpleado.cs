    ...
    public partial class frmEmpleado : MetroForm
    {
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Program.Evento == 0)
                {
                    ...
                    E.Empresa = cbempresa.SelectedItem.ToString();
                    E.Cargo = cbcargoi.SelectedItem.ToString();
                    ValoresCheck();
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            if (dtgvEmpleado.SelectedRows.Count > 0)
            {
                ...
                txtnombre.Focus();
                cbempresa.SelectedItem= dtgvEmpleado.CurrentRow.Cells[7].Value.ToString();
                cbcargoi.SelectedItem = dtgvEmpleado.CurrentRow.Cells[8].Value.ToString();
                Program.Evento = 1;
            }
            else
            {
